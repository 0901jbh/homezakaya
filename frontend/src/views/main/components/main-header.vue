    ...
    <div class="hide-on-small">
      ...
      <div class="tool-wrapper">
        ...
        <div class="button-wrapper">
          <el-button type="primary" @click="loginWithGoogle">로그인</el-button>
        ...
        <div class="mobile-sidebar">
          <div class="mobile-sidebar-tool-wrapper">
            <div class="logo-wrapper"><div class="ic ic-logo"/></div>
              ...
              <el-button class="mobile-sidebar-btn register-btn" @click="clickLogout">회원가입</el-button>
            </div>
          <el-menu
...
const firebaseConfig = {
  apiKey: "AIzaSyBEc9OBqmvrk9s82V7PTo89ue-BtLztO0o",
  authDomain: "skeleton-549b7.firebaseapp.com",
  projectId: "skeleton-549b7",
  storageBucket: "skeleton-549b7.appspot.com",
  messagingSenderId: "346002483551",
  appId: "1:346002483551:web:c0dcc01aa4b0c1929aeeea"
};
